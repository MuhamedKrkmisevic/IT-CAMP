...
if (broj % 2 === 1) {
  ...
  console.log("niste uneli broj hadaljevi");
}

// napisati program koji :
// ako je unet broj veci od nula stampa poruku broj je pozitivan u suprotnom broj je negativan

const broj1 = Number(prompt("Unesite vas broj"));
if (broj1 > 0) {
  ...
  console.log("nije nikakav broj nemoj lagat");
}
...
// default rezervisana rec odredjuje kod koji ce se izvrsiti ako nijedan od prethodnih slucajeva
// nije zadovoljen .
...
// const broj2 = Number(prompt("Unesite vas broj"));
// switch (broj2);{
//     case 12 :
//         (broj2);
//         break;
