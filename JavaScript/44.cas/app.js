...
const squareList = (arr) => {
  ...
  squares = filtered.map(function (number) {
    return number ** 2;
  });
  return squares;
};
console.log(squareList(niz));
// Napraviti funkciju koja nam vraca novi niz

// const niz1 = [12, 1, 3, 2, 3, 4, 6, 4];
// const eraseDuplicate = function (arr) {
//   const bezNjih = arr.filter((element) =>
//     arr.includes(element % element === 1)
//   );
//   return bezNjih;
// };

// console.log(eraseDuplicate(niz1));
const niz1 = [12, 1, 3, 2, 3, 4, 6, 4];
const eraseDuplicate = function (arr) {
  const newArr = [];
...
const eraseDuplicate2 = (arr) => {
  let newArr = [];
  newArr = arr.filter((element) => !newArr.includes(element));
  return newArr;
};
console.log(eraseDuplicate2(niz1));

// spread operator nam sluzi za pravljenje kopije niza ili objekta kao i spakjanje vise nizova(objekata)

const niz2 = ["sto", "stolica", "tabla", "marker"];
const niz3 = [...niz1];
niz2[1] = "fotelja";
console.log(niz2);
// Spajanje vise nizova

const niz4 = [...niz2, ...niz3];
console.log(niz4);
const niz5 = [15, ...niz3];
console.log(niz5);
const obj = {
...
const newObj = { ...obj, bojaKose: "crna", kovrdzav: false };
console.log(newObj);
// Napraviti funkciju koja vraca novi niz, gde je svaki element objekat sa vrednostima title i buget
const movies = [{ title: "inception", rating: 5, budget: "230M" }];
const bezRate = (arr) => {};
